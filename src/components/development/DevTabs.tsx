            ...
            <div>
              <div className="dev-two-col">
                <div>
                  ...
                  <Link href="/brownfields" className="btn btn-primary">Brownfields Program</Link>
                </div>
                <div>
            ...
            <div>
              <div className="dev-two-col">
                <div>
                  ...
                  <Link href="/financing" className="btn btn-primary">Financing &amp; Projects</Link>
                </div>
                <div>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    <div className="dev-info-card">
                ...
                <div className="rfp-card">
                  ...
                  <div className="rfp-body">
                    ...
                    <div className="rfp-meta">
                      ...
                      <a href="/documents/RFP-Port-Lorain-Marina.pdf" target="_blank" rel="noopener noreferrer" className="btn btn-gold btn-sm" style={{ marginLeft: 'auto' }}><i className="fas fa-download" style={{ marginRight: '0.4rem' }}></i>View RFP</a>
                    </div>
                  </div>
                </div>
