        ...
        <div className="container">
          <div className="nav-inner">
            ...
            <ul className="nav-menu" id="nav-menu" role="menubar">
              ...
              <li className="has-dropdown" role="none">
                <Link href="/events" role="menuitem" aria-haspopup="true" aria-expanded="false">Events &amp; Boat Tours <i className="fas fa-chevron-down"></i></Link>
                <ul className="dropdown" role="menu" aria-label="Events & Boat Tours">
                  <li role="none"><Link href="/events" role="menuitem">Events &amp; Boat Tours</Link></li>
                  <li role="none"><Link href="/fireworks" role="menuitem">July 4th Fireworks</Link></li>
                </ul>
              </li>
              <li className="has-dropdown" role="none">
